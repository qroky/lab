...
| Input product(s) | ATOM-006 INPUT §3.4 (pilot mode, telemetry scope, Flow Support v0, SLA, ATOM-007 boundary), §3.2 (repo separation), §3.9; `decisions/INFO-001-pilot-terms-accelerator-partner.md` (exchange + red lines); `pricing/pricing-ladder.md` (assumptions the pilot must convert to data); `channels/channel-comparison.md` (capacity kill trigger, bank-bridge role) |
