...
§3.7 verbatim: ladder self-hosted free (open core) → Flow Support (observation + interventions + monthly report) → managed. Unit-economics MUST use real cost data from this repo's cost blocks (full atom cycle ≈ 90–120k tokens; verify ≈ read×3.5+constant); [приватный слой — ревизия владельца, GATE-032]. §3.9: no unsourced numbers.
