---
atom: ATOM-091
product: kickoff sale kit — партнёр-акселератор (MD) (готов к действию рукой CEO в тот же день)
...
партнёр-акселератор (MD) и, далее, в двух названных фаундеров с подписанными
согласиями. Ты готовишь каждое касание периметра; отправляет и говорит CEO.

## 2. Files you may read (the law and the assets)
1. `decisions/INFO-001-pilot-terms-accelerator-partner.md` — обмен + red lines (VERBATIM — цитировать, не пересказывать)
